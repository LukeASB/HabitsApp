...
| Password      | string | User's password        | 1secret?Password   |
...
| name             | string   | Name of the habit                        | Read Everyday Updated                    |
| days             | integer  | Current number of days completed         | 30                                |
...
### 4. Update All Habit
**Endpoint** `PUT /dohabitsapp/v1/updatehabits`
...
Request Body:
The request body contains an array of habit objects. Each object within the array represents a habit, and has the following fields:
| Field            | Type     | Description                               | Example                           |
|------------------|----------|-------------------------------------------|-----------------------------------|
| name             | string   | Name of the habit                        | Read Everyday Updated                    |
| days             | integer  | Current number of days completed         | 30                                |
...
Response Body:
The response body contains an array of habit objects. Each object within the array represents a habit, and has the following fields:
| Field            | Type     | Description                               | Example                           |
|------------------|----------|-------------------------------------------|-----------------------------------|
| name             | string   | Name of the habit                        | Read Everyday Updated                    |
| days             | integer  | Current number of days completed         | 30                                |
