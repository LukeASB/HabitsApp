...
func checkEnvVariablesArePopulated() error {
	requiredEnvVars := []string{"DB_URL", "DB_NAME", "USERS_COLLECTION", "USER_SESSION_COLLECTION", "HABITS_COLLECTION", "ENV", "PORT", "SITE_URL", "API_NAME", "APP_VERSION", "API_VERSION", "LOG_VERBOSITY", "JWT_SECRET", "DEBUG"}
