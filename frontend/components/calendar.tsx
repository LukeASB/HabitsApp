    ...
    return (
        <div className="calendar">
            ...
            <div className="calendar-grid">
                <div id="weekday-headers" className="d-flex">{daysOfWeek.map(day => <div className="day-header flex-fill text-center fw-bold" key={day} style={{ width: "calc(100% / 7)" }}>{day}</div>)}</div>
